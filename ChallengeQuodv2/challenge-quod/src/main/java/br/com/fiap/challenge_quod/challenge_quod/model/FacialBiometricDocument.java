...
@Document(collection = "Facial")
public class FacialBiometricDocument {
    ...
    public FacialBiometricDocument(String transacaoId, String tipoBiometria, String tipoFraude, String dataCaptura,
        ...
        this.canalNotificacao = canalNotificacao != null ? canalNotificacao : Arrays.asList("sms", "email"); // Valor padrão
    ...
    public void setFraudeStatus(int fraudeStatus) { this.fraudeStatus = fraudeStatus; }
